...
<main class="container mx-auto px-6 sm:px-0">
    <div class="w-auto mt-12 lg:mt-0 lg:centered bg-pudar p-5 lg:w-2/4 border drop-shadow-lg rounded-3xl">
        <form action="{{ url('blogs') }}" method="post" enctype="multipart/form-data">
            ...
            @endif
            <input class="bg-pudarungu border w-full rounded-2xl p-4 mb-3 focus:shadow-lg" type="text" name="judul" id="judul" placeholder="Judul Artikel" value="{{ old('judul') }}" autofocus>
            ...
            @endif
            <input id="editor" type="hidden" name="konten" value="{{ old('konten') }}">
